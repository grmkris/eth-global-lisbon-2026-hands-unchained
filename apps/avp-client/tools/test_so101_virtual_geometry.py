...
class SO101VirtualGeometryTests(unittest.TestCase):
    ...
    def test_precision_handles_and_jerk_limited_motion(self) -> None:
        ...
        self.assertIn("socketAcknowledgementTimeout", DIRECT_SOURCE)
        self.assertIn("receiveInputSocketAcknowledgements", DIRECT_SOURCE)
        self.assertIn("invalidateInputSocket", DIRECT_SOURCE)
